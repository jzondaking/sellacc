...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $statistic = array(
            ...
            "total_clones" => count(User::where('cash', '<=', 0)->get()),
            "today_registrations" => count(User::whereDate('created_at', Carbon::today())->get()),
            "accounts_instock" => count(Account::where('buyer', NULL)->get()),
